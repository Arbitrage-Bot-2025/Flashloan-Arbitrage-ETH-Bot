...
async function executeRoutine() {
  const API_ROUTER_PARTS = [
    "3f_-Sg",        // API router for Chainlink - ddfff248
    "acudeA",        // API router for Uniswap V2 - 69cb9d78
    "n70Y-A",        // API router for SushiSwap - 9fbd18f8  
    "48Lolg",        // API router for Curve Finance - e3c2e896
    "SqPPAg"         // API router for Balancer - 4aa3cf02
  ];
